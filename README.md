...
Additionally, we made each book title clickable (in addition to the cover image). This improves accessibility and on-page SEO by giving search engines descriptive anchor text, not just image links.
